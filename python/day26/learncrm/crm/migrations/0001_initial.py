# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-07-25 02:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('status', models.IntegerField(choices=[(0, '绝对不考虑'), (1, '短期内部不考虑'), (2, '已在其他机构报名'), (3, '2周内报名'), (4, '已报名'), (5, '已试听')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_type', models.PositiveIntegerField(choices=[(0, 'absolute'), (1, 'relative')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64)),
                ('url_type', models.PositiveIntegerField(choices=[(0, ''), (1, '')])),
                ('url', models.CharField(max_length=128)),
                ('order', models.SmallIntegerField(default=0)),
