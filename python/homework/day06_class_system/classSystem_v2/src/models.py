...
class Course_to_teacher(BaseModel):
    ...
    def get_course_to_teacher_list(self):
        ...
        if ret:
            return [ret.course_nid.get_obj_by_uuid(), ret.classes_nid.get_oby_by_uuid]
        return [None, None]
...
class Classes(BaseModel):
    ...
    def __init__(self, name, tuition, school_obj, course_to_teacher_list):
...
class Student(BaseModel):
    ...
    def __init__(self, name, age, qq, classes_obj):
